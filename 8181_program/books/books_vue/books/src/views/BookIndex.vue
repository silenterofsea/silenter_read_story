                ...
                <b-row class="mb-3">
                    ...
                    <b-col  clos="12" md="8"> <!-- 放图书信息 -->
                            ...
                            <b-jumbotron header-level="0" class="pt-3">
                                ...
                                <div class="mb-3">最新更新时间：{{ items.indexItems[0].book_last_update_time | dateFormat }}</div>
    ...
    setup(props, context){
        ...
        GetInfoPost(indexParams).then(resp =>{
            ...
            GetInfoPost(titlePramas).then(resp => {
                ...
                document.title = items.indexItems[0].book_name+'('+items.indexItems[0].book_author+')最新章节_'+items.indexItems[0].book_name+resp.data.data[0];
                // 沧元图最新章节列表,沧元图无弹窗广告,沧元图全文阅读,我吃西红柿
                // document.querySelector('meta[name="keywords"]').setAttribute("content", items.indexItems[0].book_name +'_'+resp.data.data[1]);
                document.querySelector('meta[name="keywords"]').setAttribute("content", items.indexItems[0].book_name +'最新章节列表,'+items.indexItems[0].book_name +'无弹窗广告,'+items.indexItems[0].book_name +'全文阅读,'+items.indexItems[0].book_author);
                //我吃西红柿大神最新作品《沧元图》最新章节全文免费阅读，沧元图全集，沧元图5200，沧元图无弹窗！请关注沧元图吧，本站最新最快更新沧元图最新章节。
                ...
                document.querySelector('meta[name="description"]').setAttribute("content", items.indexItems[0].book_author+'大神最新作品《'+items.indexItems[0].book_name+'》最新章节全文免费阅读，'+items.indexItems[0].book_name+'全集，'+items.indexItems[0].book_name+'5200,'+items.indexItems[0].book_name+'无弹窗！请关注'+items.indexItems[0].book_name+'吧，本站最新最快更新沧元图最新章节。');
            });
